package com.tinyquest.hub.auth.document;
...
public interface AuthRestControllerDoc {
    ...
    @Operation(
            ...
            responses = {
                    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "갱신 성공", content = @Content(schema = @Schema(implementation = TokenResponse.class)))
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "로그아웃 성공", content = @Content(schema = @Schema(implementation = ApiResponse.Success.class)))
            }
    )
    ApiResponse<Void> logout(AuthPrincipal principal, @Valid LogoutRequest request);
    ...
    @Operation(
            ...
            responses = {
                    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "전체 로그아웃 성공", content = @Content(schema = @Schema(implementation = ApiResponse.Success.class)))
            }
    )
    ApiResponse<Void> logoutAll(AuthPrincipal principal, LogoutAllRequest request);
    ...
    @Operation(
            ...
            responses = {
                    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "철회 성공", content = @Content(schema = @Schema(implementation = ApiResponse.Success.class)))
            }
    )
    ApiResponse<Void> revokeAccessToken(AuthPrincipal principal, @Valid RevokeAccessRequest request);
}
